...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    private LootItemCondition.Builder hasHammer() { return MatchTool.toolMatches(ItemPredicate.Builder.item().of(this.registries.lookupOrThrow(Registries.ITEM), ModTags.Items.HAMMERS_ITEMS)); }
