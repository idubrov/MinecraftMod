...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shaped(RecipeCategory.MISC, ModBlocks.SULFUR_BLOCK.get(), 1)
                .pattern("SSS")
                .pattern("SSS")
                .pattern("SSS")
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.PALM_SLAB.get(), 6)
                .group("wooden_slab")
                .pattern("###")
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.PALM_STAIRS.get(), 4)
                .group("wooden_stairs")
                .pattern("#  ")
                .pattern("## ")
                .pattern("###")
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRY_PALM_LEAVES_BLOCK.get(), 1)
                .pattern("LLL")
                .pattern("LLL")
                .pattern("LLL")
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRY_PALM_LEAVES_SLAB.get(), 1)
                .pattern("LLL")
                .pattern("LLL")
                .pattern("   ")
                .define('L', ModBlocks.PALM_LEAVES.get())
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRY_PALM_LEAVES_CARPET.get(), 1)
                .pattern("LLL")
                .pattern("   ")
                .pattern("   ")
                .define('L', ModBlocks.PALM_LEAVES.get())
        ...
        shaped(RecipeCategory.FOOD, ModItems.MILK_SHAKE.get(), 3)
                .pattern("M  ")
                .pattern("BBB")
                .pattern("   ")
        ...
        shaped(RecipeCategory.FOOD, ModItems.NIGIRI_SUSHI.get(), 6)
                .pattern("FKF")
                .pattern("RKR")
                .pattern("RKR")
        ...
        shaped(RecipeCategory.FOOD, ModItems.MAKI_SUSHI.get(), 6)
                .pattern("RFR")
                .pattern("KKK")
                .pattern("RFR")
                .define('R', ModItems.RICE_SEEDS.get())
        ...
        shaped(RecipeCategory.FOOD, ModBlocks.RICE_PUDDING.get(), 1)
                .pattern("BCB")
                .pattern("RBR")
                .pattern("RRR")
                .define('R', ModItems.RICE_SEEDS.get())
        ...
        shaped(RecipeCategory.MISC, ModItems.BATTERY.get(), 3)
                .pattern("III")
                .pattern("SSS")
                .pattern("CCC")
        ...
        shaped(RecipeCategory.MISC, ModBlocks.COCONUT_LAMP.get(), 1)
                .pattern("   ")
                .pattern("ACA")
                .pattern("   ")
        ...
        oreSmelting(this.output, SULFUR_SMELTABLES, RecipeCategory.MISC, ModItems.SULFUR_POWDER.get(), 0.5f, 100, "sulfur");
        oreBlasting(this.output, SULFUR_SMELTABLES, RecipeCategory.MISC, ModItems.SULFUR_POWDER.get(), 0.7f, 80, "sulfur");


        buttonBuilder(ModBlocks.PALM_BUTTON.get(), Ingredient.of(ModBlocks.PALM_PLANKS.get())).group("wooden_button")
                .unlockedBy("has_palm_planks", has(ModBlocks.PALM_PLANKS.get())).save(this.output);
        ...
        shaped(RecipeCategory.TOOLS, ModItems.WOODEN_HAMMER.get(), 1)
                .pattern(" WW")
                .pattern(" SW")
                .pattern("S  ")
        ...
        shaped(RecipeCategory.TOOLS, ModItems.STONE_HAMMER.get(), 1)
                .pattern(" WW")
                .pattern(" SW")
                .pattern("S  ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.GOLDEN_HAMMER.get(), 1)
                .pattern(" WW")
                .pattern(" SW")
                .pattern("S  ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.IRON_HAMMER.get(), 1)
                .pattern(" WW")
                .pattern(" SW")
                .pattern("S  ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.DIAMOND_HAMMER.get(), 1)
                .pattern(" WW")
                .pattern(" SW")
                .pattern("S  ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_PICKAXE.get(), 1)
                .pattern("IBI")
                .pattern(" S ")
                .pattern(" S ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_AXE.get(), 1)
                .pattern("BI ")
                .pattern("IS ")
                .pattern(" S ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_SHOVEL.get(), 1)
                .pattern(" B ")
                .pattern(" S ")
                .pattern(" S ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_HOE.get(), 1)
                .pattern("IB ")
                .pattern(" S ")
                .pattern(" S ")
                .define('S', Items.STICK)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_HELMET.get(), 1)
                .pattern("BNB")
                .pattern("I I")
                .pattern("   ")
                .define('I', Items.IRON_INGOT)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_CHESTPLATE.get(), 1)
                .pattern("B B")
                .pattern("INI")
                .pattern("IBI")
                .define('I', Items.IRON_INGOT)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_LEGGINGS.get(), 1)
                .pattern("BNB")
                .pattern("I I")
                .pattern("I I")
                .define('I', Items.IRON_INGOT)
        ...
        shaped(RecipeCategory.TOOLS, ModItems.ELECTRIC_BOOTS.get(), 1)
                .pattern("   ")
                .pattern("BNB")
                .pattern("I I")
                .define('I', Items.IRON_INGOT)
        ...
        shaped(RecipeCategory.MISC, ModBlocks.TELEPORTATION_STONE.get(), 1)
                .pattern("IEI")
                .pattern("NLN")
                .pattern("IBI")
                .define('B', ModItems.BATTERY.get())
        ...
        shaped(RecipeCategory.MISC, ModItems.TELEPORTATION_DEVICE.get(), 1)
                .pattern("   ")
                .pattern("BIB")
                .pattern(" E ")
                .define('I', Items.IRON_INGOT)
