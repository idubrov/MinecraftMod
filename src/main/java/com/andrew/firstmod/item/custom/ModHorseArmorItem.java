...
public class ModHorseArmorItem extends AnimalArmorItem {
    public ModHorseArmorItem(Holder<ArmorMaterial> armorMaterial, BodyType bodyType, boolean hasOverlay, Properties properties) {
    ...
    public void onAnimalArmorTick(ItemStack stack, Level level, Mob mob) {
        if (mob instanceof Horse horse && !level.isClientSide()) {
            horse.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 60, 2, false, false));
        }
